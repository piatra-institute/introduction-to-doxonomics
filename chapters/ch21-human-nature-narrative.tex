...
This regime is not presented as ideology. It is presented as science: the sober conclusion of economics, evolutionary biology, and rational choice theory.
...
No society tested exhibited the pure self-interest predicted by the homo economicus model \autocite{henrich2020}.
...
Cooperation activates reward centers in the brain (striatum, ventromedial prefrontal cortex) even when the cooperator receives no material benefit \autocite{rilling2002}.
Rejecting unfair offers in ultimatum games activates the anterior insula, a region associated with disgust \autocite{sanfey2003}.
...
\begin{itemize}[nosep]
  \item \textbf{Pareto} (1906): ordinal utility theory, in which agents have well-ordered preferences, interpreted as self-regarding.
  \item \textbf{Robbins} (1932): economics as the science of allocating scarce means among competing ends, with no room for altruism, solidarity, or non-instrumental motivation.
  \item \textbf{Von Neumann and Morgenstern} (1944): expected utility theory, in which the rational agent maximizes expected payoff.
...
\begin{enumerate}[nosep]
  \item \textbf{Undergraduate economics} ($\sim$1.5M students/year in the US, comparably-scaled cohorts in the UK, India, China, and across the EU): Intro courses teach self-interest as the motivational axiom. Most students take only the intro course, absorbing the axiom without encountering the behavioral qualifications taught in advanced courses.
  \item \textbf{MBA programs} ($\sim$200K graduates/year in the US; over 500K worldwide once Indian and Chinese MBA expansions are included): Principal-agent theory, incentive design, and shareholder primacy deepen the self-interest assumption and apply it to organizational design.
...
The financial-media circuit runs in parallel across the major capital markets: CNBC, Bloomberg, and the Wall Street Journal (US); the Financial Times and Economist (UK, global); Nikkei (Japan); CNBC-TV18 and ET Now (India); Globo's Valor (Brazil).
All operate within the self-interest framework as default: market movements are explained by ``rational'' responses to incentives; cooperation is a ``market failure''; regulation is ``interference'' with natural market processes.
The aggregate audience of financial media in the US exceeds 50 million; in India and China the audiences are larger still in absolute terms.

\paragraph{Entertainment.}
The ``greed is good'' speech in \emph{Wall Street} (1987, US) became cultural shorthand for a worldview already institutionalized; comparable national-cinematic statements exist (Britain's \emph{Wolf of Wall Street} reception, India's \emph{Guru} (2007), Brazil's \emph{Pixote}-to-\emph{Sucesso}-arc narratives, China's \emph{Boss \& Me} 2014).
...
The student leaves the course believing that most people are selfish.
She has not been argued into it; she has absorbed it as the unquestioned premise of every exercise she completed.
...
Over time the regime shapes propositional belief and the precision assigned to affect: which gut responses are treated as evidence, and which are treated as noise to be overridden.
...
Imposing fines for late pickup at daycare centers \emph{increases} lateness, as parents treat the fine as a price, replacing a social norm with a market transaction \autocite{gneezy2000}.

Through the policy feedback loop, the selfishness regime generates the behavior it claims to describe.
