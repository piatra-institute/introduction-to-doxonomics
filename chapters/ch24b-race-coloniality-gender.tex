...
\begin{itemize}[nosep]
  ...
  \item \textbf{Popular science and media}: National Geographic's century of racial representation, IQ testing popularization, the ``bell curve'' discourse.
\end{itemize}
...
If segregation $S(t)$ is itself a function of racial belief ($S(t) = h(\belief{R}(t))$ with $h' > 0$---stronger racial belief leads to more segregation through housing discrimination, white flight, school district formation), then the system has a positive feedback loop:
\[
...
\begin{enumerate}[nosep]
  ...
  \item new narrative forms emerged: ``colorblind racism'' (denying the relevance of race while maintaining racial structures), ``cultural deficit'' explanations (attributing racial inequality to cultural rather than biological differences, but with the same doxonomic function), and ``reverse racism'' narratives (reframing anti-racist policy as the ``real'' racism),
...
\begin{proposition}[Doxonomic Intersection]
...
The history of scientific racism is documented in Gould (1981) and Kendi (2016).
Colonial knowledge production is analyzed in \textcite{said1978}.
On coloniality as persisting beyond formal colonialism, see Quijano (2000) and Mignolo (2011).
...
For the ``welfare queen'' as a doxonomic construction, see Gilens (1999).

The intersectionality framework originates with Crenshaw (1989).
