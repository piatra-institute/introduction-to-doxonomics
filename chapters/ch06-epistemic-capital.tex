...
Consider five institutions and their approximate capital vectors:
...
The doxonomic strategy of channeling narratives through complementary institutions---from Heritage (credibility + authority) through the \textit{Times} (attention + credibility) to social media (attention)---exploits the comparative advantage of each.
\end{example}
...
This creates an institutional incentive against public engagement---which, from a doxonomic perspective, means that the highest-credibility institutions systematically underinvest in public communication, leaving the public information environment to lower-credibility sources.
\end{example}
