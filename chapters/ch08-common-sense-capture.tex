...
It is making a belief so pervasive that it ceases to be recognized as a belief at all---when a funded narrative becomes invisible infrastructure, indistinguishable from the texture of reality.
...
\begin{enumerate}[nosep]
  \item \textbf{Contested (pre-1950s)}: alternative objectives were actively debated---full employment, social solidarity, moral improvement, imperial expansion, class harmony.
