...
\textcite{mayer2016} estimates that hundreds of millions of dollars flow annually through donor-advised funds and pass-through foundations in the US, with the ultimate source legally obscured; comparable opacity holds in UK (charity-trust structures), German (foundation law shielding ultimate donors), and Brazilian (institutos legally distinct from sponsoring corporates) channels, though the legal vehicles differ.
...
A donor's preference for deregulation enters Heritage Foundation in the US, or the Institute of Economic Affairs in the UK, or an Atlas-network affiliate in Brazil or India, as a grant; it exits as a policy brief with citations, data tables, and expert endorsement.
