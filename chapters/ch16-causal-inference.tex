...
Following \textcite{gentzkow2010}, adjacent localities on opposite sides of a media market boundary receive different television content despite sharing demographic and economic characteristics.
The method is jurisdiction-portable: any partition of geography that is determined by signal range, channel-allocation rules, or licensing decisions, and is plausibly unrelated to local political preferences, generates the same identifying variation.
In the US, channel-position assignment within cable systems provides a within-county instrument: if county $A$ receives Fox News at channel position 2 and county $B$ receives it at channel position 73, channel position creates quasi-random variation in exposure.
In Italy, the geographic roll-out of Berlusconi's Mediaset signal between 1981 and 1985 generated a comparable boundary design: municipalities that gained Mediaset coverage years earlier showed measurably different political preferences decades later \autocite{durante2019}.
In Russia, regional variation in the signal reach of the independent NTV network provided an analogous source of quasi-random exposure to non-state broadcasting in the 1990s \autocite{enikolopov2011}.
...
\begin{itemize}[nosep]
  ...
  \item the entry of Fox News into US cable markets in the late 1990s \autocite{dellavigna2007} and, by close analogy, the staged geographic rollout of Berlusconi's Mediaset in Italy 1981--1985 \autocite{durante2019},
  \item the expansion of independent radio and television in 1990s Russia, with NTV's signal-reach variation generating exogenous exposure to non-state broadcasting \autocite{enikolopov2011},
  \item the expansion of radio coverage in pre-1933 Germany, which moved with party-vote outcomes and remains a canonical natural experiment in propaganda effects \autocite{adena2015},
...
Regulatory changes that affect narrative production or distribution provide natural experiments. The class is jurisdiction-portable; concrete instances include:
\begin{itemize}[nosep]
  \item the US repeal of the Fairness Doctrine (1987) and subsequent growth of partisan talk radio,
  \item the UK Political Parties, Elections and Referendums Act 2000 (PPERA) and the contrast with the post-\emph{Citizens United} regime in the US, both of which altered the volume and source structure of political advertising \autocite{ewing2017},
  \item foreign-ownership and cross-media restrictions on broadcasting (varying across Australia, Canada, the EU member-state regimes, and India under the 2014--2020 regulatory updates),
...
\begin{example}
\label{ex:iv-channel}
The cleanest worked instance of an IV strategy for media exposure is the US channel-position design: we instrument Fox News viewership with channel position, following \textcite{dellavigna2007}.
...
The same IV class applies elsewhere: Italian Mediaset coverage timing instruments contemporary political preferences \autocite{durante2019}, and German radio signal availability instruments party-vote shifts in the pre-Nazi period \autocite{adena2015}.
