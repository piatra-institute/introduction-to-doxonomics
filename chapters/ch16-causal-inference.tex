...
\begin{enumerate}[nosep]
  \item \textbf{Relevance}: $\operatorname{Cov}(Z, D) \neq 0$---the instrument predicts exposure.
  \item \textbf{Exclusion}: $Z$ affects belief $Y$ only through exposure $D$---no direct effect.
  \item \textbf{Independence}: $Z \perp\!\!\!\perp U$---the instrument is uncorrelated with unobserved confounders.
\end{enumerate}
